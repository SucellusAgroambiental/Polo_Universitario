var size = 0;
var placement = 'point';
function categories_InspeoBlocosPontosdeAteno_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Caixa d\'água sem tampa':
...
case 'Telha Quebrada':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(117,58,128,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(149,74,162,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
                    break;
case 'Telha Remendada':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
...
var style_InspeoBlocosPontosdeAteno_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("POI");
    var labelText = "";
    size = 0;
...
var style = categories_InspeoBlocosPontosdeAteno_6(feature, value, size, resolution, labelText,
